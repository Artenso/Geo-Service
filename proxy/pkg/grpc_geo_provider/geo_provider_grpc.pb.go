...
const (
	GeoProvider_AddressSearch_FullMethodName = "/github.com.Artenso.Geo_Service.geo.api.GeoProvider/AddressSearch"
	GeoProvider_GeoCode_FullMethodName       = "/github.com.Artenso.Geo_Service.geo.api.GeoProvider/GeoCode"
)
...
func (c *geoProviderClient) AddressSearch(ctx context.Context, in *AddressSearchRequest, opts ...grpc.CallOption) (*AddressSearchResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeoProvider_AddressSearch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *geoProviderClient) GeoCode(ctx context.Context, in *GeoCodeRequest, opts ...grpc.CallOption) (*GeoCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, GeoProvider_GeoCode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var GeoProvider_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.Artenso.Geo_Service.geo.api.GeoProvider",
